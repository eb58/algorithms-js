...
const magicFilter4x4 = (x) => {
  ...
  if (x.length === 7 && x[4] + x[5] + x[6] >= 34) return false;
  if (x.length === 7 && x[4] + x[5] + x[6] < 34 - 16) return false;
  ...
  // vertical
  if (x.length === 9 && x[0] + x[4] + x[8] >= 34) return false;
  if (x.length === 9 && x[0] + x[4] + x[8] <= 34 - 16) return false;
  ...
  // diag
  if (x.length === 10 && x[3] + x[6] + x[9] >= 34) return false;
  if (x.length === 10 && x[3] + x[6] + x[9] < 34 - 16) return false;

  if (x.length === 11 && x[0] + x[5] + x[10] >= 34) return false;
  if (x.length === 11 && x[0] + x[5] + x[10] < 34 - 16) return false;
